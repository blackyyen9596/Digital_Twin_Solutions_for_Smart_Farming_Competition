...
PATH_generate = r'D:\dataset\2021智慧農業數位分身創新應用競賽\dataset_lstm'
...
# # 存檔.npy
np.save(os.path.join(PATH_generate, 'train_val_data.npy'), train_data)
np.save(os.path.join(PATH_generate, 'train_val_label.npy'), train_label)
